(function ()
{
    ...
    /** @ngInject */
    function containersController($state, $scope, $mdDialog, $document, Statuses, Orders)
    {
        var vm = this;
        ...
        vm.dtOptions = {
            ...
            {
                var api = this.api(),
                    searchBox = angular.element('body').find('#containers-products-search');
        ...
        {
            $state.go('app.admin.containers.orders.detail', {id: id});
        }
        ...
        function addDialog(ev)
        {
            $mdDialog.show({
                ...
                controllerAs       : 'vm',
                templateUrl        : 'app/main/apps/containers/views/dialogs/add-edit/add-dialog.html',
        ...
        function editDialog(ev, formView, formData)
        {
            $mdDialog.show({
                controller         : 'GanttChartAddEditDialogController',
                controllerAs       : 'vm',
                templateUrl        : 'app/main/apps/containers/views/dialogs/add-edit/edit-dialog.html',
                parent             : angular.element($document.body),
                targetEvent        : ev,
                clickOutsideToClose: true,
                locals             : {
