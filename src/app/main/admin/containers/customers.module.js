(function ()
{
    ...
    function config($stateProvider, $translatePartialLoaderProvider, msApiProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider
            ...
            .state('app.admin.containers.list', {
                url      : '/list',
                views    : {
                    'content@app': {
                        templateUrl: 'app/main/apps/containers/views/list-view/containers.html',
                ...
                resolve  : {
                    ...
                    {
                        return msApi.resolve('containers.orders@get');
                    },
                    Statuses: function (msApi)
                    {
                        return msApi.resolve('containers.statuses@get');
                    }
                },
        ...
        // Translation
        $translatePartialLoaderProvider.addPart('app/main/apps/containers');
