(function ()
{
    ...
    /** @ngInject */
    function OrdersController($state, $scope, $mdDialog, $document, Statuses, Orders)
    {
        var vm = this;
        ...
        function addDialog(ev)
        {
            $mdDialog.show({
                ...
                controllerAs       : 'vm',
                templateUrl        : 'app/main/apps/e-commerce/views/dialogs/add-edit/add-dialog.html',
        ...
        function editDialog(ev, formView, formData)
        {
            $mdDialog.show({
                controller         : 'GanttChartAddEditDialogController',
                controllerAs       : 'vm',
                templateUrl        : 'app/main/apps/e-commerce/views/dialogs/add-edit/edit-dialog.html',
                parent             : angular.element($document.body),
                targetEvent        : ev,
                clickOutsideToClose: true,
                locals             : {
